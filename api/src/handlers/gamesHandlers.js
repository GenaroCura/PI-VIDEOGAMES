const {createVideoGame, getAllGame,getGameByName, getGameById}= require ("../controllers/videoGamesControllers");
...
const createVideoGameHandler =  async (req,res) => {
    ...
    try {
        const result = await  createVideoGame(name,description,platforms,image,released,rating,genres)
